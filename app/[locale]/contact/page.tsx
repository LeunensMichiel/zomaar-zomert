  ...
  return (
    <section className="relative isolate bg-pink-50">
      ...
      <div className="container-wide relative z-20 pt-6 pb-12 md:pt-8 md:pb-16">
        {/* Header row — mirror of /info: chunky block headline on
            the right, lips doodle on the left. Yellow-on-black with
            a positive tilt to differentiate from /info's
            pink-on-black, negative-tilt block. */}
